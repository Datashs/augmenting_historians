...
éventuelle  est dans la distribution agrégée (portrait rhétorique du texte entier) et dans
les signaux de localisation produits ici.
...
def portrait_agregé(fused: list[dict]) -> dict:
    ...
    signature d'ensemble qui dit probablement quelque chose sur le style du texte.
    """
    n = len(fused)
    if n == 0:
        return {}
